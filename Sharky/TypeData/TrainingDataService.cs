    ...
    public class TrainingDataService
    {
        public Dictionary<UnitTypes, TrainingTypeData> TrainingData()
        {
            return new Dictionary<UnitTypes, TrainingTypeData>
            {
                ...
                { UnitTypes.TERRAN_CYCLONE, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.TERRAN_FACTORY }, Minerals = 100, Gas = 50, Food = 2, Ability = Abilities.TRAIN_CYCLONE, RequiresTechLab = true } },
