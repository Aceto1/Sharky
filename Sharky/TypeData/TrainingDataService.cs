    ...
    public class TrainingDataService
    {
        public Dictionary<UnitTypes, TrainingTypeData> TrainingData()
        {
            return new Dictionary<UnitTypes, TrainingTypeData>
            {
                ...
                { UnitTypes.PROTOSS_MOTHERSHIP, new TrainingTypeData { ProducingUnits = new HashSet<UnitTypes> { UnitTypes.PROTOSS_NEXUS }, Minerals = 400, Gas = 400, Food = 8, Ability = Abilities.TRAIN_MOTHERSHIP, Time = 79 } },
